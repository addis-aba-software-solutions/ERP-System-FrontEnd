...
class PurchaseOrder extends Component {
    ...
    selectedPurchase=(image3)=>{
        ipcRenderer.send('toggle-image3', image3)
    }
    ...
    render() {
        return (
            <>
                ...
                <Grid>
                    <h2 style={{ padding: 20 }} className="text-center">Purchase Order Request</h2>
                    ...
                    <Button style={{ backgroundColor: "#11669F" }} className="float right">Request</Button>
